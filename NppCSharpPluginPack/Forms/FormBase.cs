...
public partial class FormBase : Form
{
    ...
    private void FormBase_VisibleChanged(object sender, EventArgs e)
    {
        ...
        // Always apply translation and styling when form becomes visible
        // This ensures the form adapts to current Notepad++ settings (theme, language) when reopened
        Translator.TranslateForm(this);
        // Apply Notepad++ styling (including dark mode)
        FormStyle.ApplyStyle(this, true);
    }
