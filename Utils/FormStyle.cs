    ...
    public static void ApplyStyle(Control ctrl, bool useNppStyle, bool darkMode = false)
    {
                ...
                backColor.B > 240))
        {
            ...
            foreach (Control child in ctrl.Controls)
            {
                ...
                if (child is TextBox || child is RichTextBox || child is ListBox || child is ComboBox || child is TreeView)
                {
        ...
        foreach (Control child in ctrl.Controls)
        {
            ...
            {
                // RichTextBox should use a slightly different background for better contrast
                rtb.BackColor = InBetween;
            }
        }
    }
}